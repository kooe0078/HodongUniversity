...
void MainScene2::Menuitem() // 구매 버튼
{
	// 1번 구매
...
void MainScene2::Pur1(Ref * pSender) // 1번 구매
{		

}				  			  
void MainScene2::Pur2(Ref * pSender) // 2번 구매
{			

}				  			  
void MainScene2::Pur3(Ref * pSender) // 3번 구매
{		

}				  		  
void MainScene2::Pur4(Ref * pSender) // 4번 구매
{		

}				  		  
void MainScene2::Pur5(Ref * pSender) // 5번 구매
{		

}				  			  
void MainScene2::Pur6(Ref * pSender) // 6번 구매
{

}
void MainScene2::Next() // 상점 1번으로
{
...
void MainScene2::Go(Ref * pSender) // 넘어가기
{
	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
	Director::getInstance()->replaceScene(MainScene::createScene());
}
void MainScene2::Exit() // 상점 나가기
{
...
void MainScene2::Back(Ref * pSender) // 나가기
{
	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
