...
void MainScene::Pur1(Ref * pSender) // 1번 구매
{		

}				  			  
void MainScene::Pur2(Ref * pSender) // 2번 구매
{			

}				  			  
void MainScene::Pur3(Ref * pSender) // 3번 구매
{		

}				  		  
void MainScene::Pur4(Ref * pSender) // 4번 구매
{		

}				  		  
void MainScene::Pur5(Ref * pSender) // 5번 구매
{		

}				  			  
void MainScene::Pur6(Ref * pSender) // 6번 구매
{

}
void MainScene::Next() // 상점 2번으로
{
...
void MainScene::Back(Ref * pSender) // 나가기
{
	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
