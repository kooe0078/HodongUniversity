...
Scene* InsideScene::createScene()
{
    auto scene = Scene::create();
    auto layer = InsideScene::create();
...
bool InsideScene::init()
{
	...
	//배경음악
	SimpleAudioEngine::getInstance()->playBackgroundMusic("sound/inside sound.mp3", true);
	//스케쥴
	this->schedule(schedule_selector(InsideScene::update));
	this->schedule(schedule_selector(InsideScene::SetLabel), 0.001f);
	////키보드 리스너
	//auto keylistener = EventListenerKeyboard::create();
	//keylistener->onKeyPressed = CC_CALLBACK_2(InsideScene::onKeyPressed, this);
	//keylistener->onKeyReleased = CC_CALLBACK_2(InsideScene::onKeyReleased, this);
	//_eventDispatcher->addEventListenerWithSceneGraphPriority(keylistener, this);

    return true;
}

void InsideScene::InitBackGround()
{
	auto sprite = Sprite::create("MiniGameResources/inside_star.png");
	sprite->setPosition(Point(visibleSize.width / 2 + origin.x, visibleSize.height / 2 + origin.y));
	this->addChild(sprite, 0);
}

//메뉴창
void InsideScene::InitMenu()
{
	...
	auto menu_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(InsideScene::menuspr, this));
	...
	auto action_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(InsideScene::actionspr, this));
	...
	auto info_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(InsideScene::infospr, this));
	...
	auto plan_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(InsideScene::planspr, this));
	...
	auto system_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(InsideScene::systemspr, this));
	...
	auto fin_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(InsideScene::finalspr, this));
...
//내정보 판업창
void InsideScene::infospr(Ref *pSender)
{
	...
	if (open == false) {
		...
		auto cancel_item = MenuItemImage::create(
			...
			CC_CALLBACK_1(InsideScene::cancelcon, this));
...
//시스템창
void InsideScene::systemspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	...
	if (open == false)
	{
		...
		auto on_item = MenuItemImage::create(
			...
			"MiniGameResources/on_swich.png",
			CC_CALLBACK_1(InsideScene::soundoff, this));
...
void InsideScene::soundoff(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	...
	auto off_item = MenuItemImage::create(
		...
		"MiniGameResources/off_swich.png",
		CC_CALLBACK_1(InsideScene::soundon, this));
...
void InsideScene::soundon(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
...
//행동 클릭시 메뉴창
void InsideScene::actionspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	...
	if (open == false) {
		...
		auto action_item = MenuItemImage::create(
			...
			// 임시 
			CC_CALLBACK_1(InsideScene::tell, this));
		...
		auto action_item1 = MenuItemImage::create(
			"MiniGameResources/UI_move5.png",
			"MiniGameResources/UI_move5pr.png",
			// 임시 
			CC_CALLBACK_1(InsideScene::alba, this));
		...
		auto action_item2 = MenuItemImage::create(
			"MiniGameResources/UI_move20.png",
			"MiniGameResources/UI_move20pr.png",
			// 임시 
			CC_CALLBACK_1(InsideScene::shop, this));
		...
		auto action_item3 = MenuItemImage::create(
			"MiniGameResources/UI_move9.png",
			"MiniGameResources/UI_move9pr.png",
			// 임시 
			CC_CALLBACK_1(InsideScene::play, this));
...
void InsideScene::tell(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);

	Singletons::getInstance()->num_5 = 4;
	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
	Director::getInstance()->replaceScene(StoryChangeScene::createScene());
}
void InsideScene::shop(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
...
void InsideScene::play(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
...
void InsideScene::menuspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
...
void InsideScene::alba(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);

	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
	Director::getInstance()->replaceScene(AlbaScene::createScene());
}
//일지 판업창
void InsideScene::planspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
...
void InsideScene::cancelcon(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
...
void InsideScene::finalspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	...
	if (open == false) {
		...
		auto exitok_item = MenuItemImage::create(
			...
			CC_CALLBACK_1(InsideScene::exitspr, this));
...
//종료 수락시
void InsideScene::exitspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
...
void InsideScene::SetLabel(float delta)
{
