...
Scene* StudentUnionScene::createScene()
{
    auto scene = Scene::create();
    auto layer = StudentUnionScene::create();
...
bool StudentUnionScene::init()
{
	...
	//배경음악
	SimpleAudioEngine::getInstance()->playBackgroundMusic("sound/student_sound.mp3", true);
	//스케쥴
	this->schedule(schedule_selector(StudentUnionScene::update));
	this->schedule(schedule_selector(StudentUnionScene::SetLabel), 0.001f);
	////키보드 리스너
	//auto keylistener = EventListenerKeyboard::create();
	//keylistener->onKeyPressed = CC_CALLBACK_2(StudentUnionScene::onKeyPressed, this);
	//keylistener->onKeyReleased = CC_CALLBACK_2(StudentUnionScene::onKeyReleased, this);
	//_eventDispatcher->addEventListenerWithSceneGraphPriority(keylistener, this);

    return true;
}

void StudentUnionScene::InitBackGround()
{
	auto sprite = Sprite::create("MiniGameResources/StuduntUnion.png");
	sprite->setPosition(Point(visibleSize.width / 2 + origin.x, visibleSize.height / 2 + origin.y));
	this->addChild(sprite, 0);
}

//메뉴창
void StudentUnionScene::InitMenu()
{
	
	//이동창
	auto menu_item = MenuItemImage::create(
		"MiniGameResources/UI_Select1red.png",
		"MiniGameResources/UI_Select1redpr.png",
		
		CC_CALLBACK_1(StudentUnionScene::menuspr, this));
	...
	auto action_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(StudentUnionScene::actionspr, this));
	...
	auto info_item = MenuItemImage::create(
		...
		"MiniGameResources/UI_Select3red[r.png",
		CC_CALLBACK_1(StudentUnionScene::infospr, this));
	...
	auto plan_item = MenuItemImage::create(
		"MiniGameResources/UI_Select6red.png",
		"MiniGameResources/UI_Select6redpr.png",
		CC_CALLBACK_1(StudentUnionScene::planspr, this));
	...
	auto system_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(StudentUnionScene::systemspr, this));
	...
	auto fin_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(StudentUnionScene::finalspr, this));
...
//내정보 판업창
void StudentUnionScene::infospr(Ref *pSender)
{
	...
	if (open == false) {
		...
		auto cancel_item = MenuItemImage::create(
			...
			CC_CALLBACK_1(StudentUnionScene::cancelcon, this));
...
//시스템창
void StudentUnionScene::systemspr(Ref *pSender)
{
	...
	if (open == false)
	{
		...
		auto on_item = MenuItemImage::create(
			...
			"MiniGameResources/on_swich.png",
			CC_CALLBACK_1(StudentUnionScene::soundoff, this));
...
void StudentUnionScene::soundoff(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	...
	auto off_item = MenuItemImage::create(
		...
		"MiniGameResources/off_swich.png",
		CC_CALLBACK_1(StudentUnionScene::soundon, this));
...
void StudentUnionScene::soundon(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	//노래 다시 온
	SimpleAudioEngine::getInstance()->playBackgroundMusic("sound/student_soundmp3", true);
	removeChildByTag(111);
	auto on_item = MenuItemImage::create(
		"MiniGameResources/on_swich.png",
		"MiniGameResources/on_swich.png",
...
//행동 클릭시 메뉴창
void StudentUnionScene::actionspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	if (open == false) {
		...
		//회비횡령
		auto action_item = MenuItemImage::create(
			"MiniGameResources/UI_redmove1.png",
			"MiniGameResources/UI_redmove1pr.png",
			// 임시 
			CC_CALLBACK_1(StudentUnionScene::sibal, this));
		...
		auto action_item1 = MenuItemImage::create(
			"MiniGameResources/UI_redmove2.png",
			"MiniGameResources/UI_redmove2pr.png",
			// 임시 
			CC_CALLBACK_1(StudentUnionScene::jangbu, this));
		...
		auto action_item2 = MenuItemImage::create(
			"MiniGameResources/UI_redmove3.png",
			"MiniGameResources/UI_redmove3pr.png",
			// 임시 
			CC_CALLBACK_1(StudentUnionScene::biza, this));
		...
		auto action_item3 = MenuItemImage::create(
			"MiniGameResources/UI_redmove4.png",
			"MiniGameResources/UI_redmove4pr.png",
			// 임시 
			CC_CALLBACK_1(StudentUnionScene::hakhue, this));
...
void StudentUnionScene::GoHome(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
	Director::getInstance()->replaceScene(StudentUnionScene::createScene());
}
void StudentUnionScene::sibal(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	if (Singletons::getInstance()->jik == 1)
	{
		...
		removeChildByTag(3001);
		removeChildByTag(3002);
		removeChildByTag(3003);
		removeChildByTag(3004);
		removeChildByTag(3005);
		removeChildByTag(9);
		removeChildByTag(10);
		removeChildByTag(8);
		removeChildByTag(11);
		auto cancel_item = MenuItemImage::create(
			"MiniGameResources/XIcon.png",
			"MiniGameResources/XIconpress.png",
			CC_CALLBACK_1(StudentUnionScene::GoHome, this));
		cancel_item->setAnchorPoint(Point(0.5, 0.5));
	...
	{
		Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
		Director::getInstance()->replaceScene(Seizure::createScene());
	}
}
void StudentUnionScene::jangbu(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	if (Singletons::getInstance()->jik <= 2)
	{
	...
	{
		Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
		Director::getInstance()->replaceScene(DataP::createScene());
	}
}
void StudentUnionScene::biza(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	if (Singletons::getInstance()->jik <= 3)
	{
	...
	{
		Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
		Director::getInstance()->replaceScene(secretFund::createScene());
	}
}
void StudentUnionScene::hakhue(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	if (Singletons::getInstance()->jik <= 4)
	{
		Sprite* system = Sprite::create("MiniGameResources/pop_rank4.png");
		system->setAnchorPoint(Point(0.5, 0));
		system->setPosition(Point(520, 460));
		system->setTag(109);
		this->addChild(system, 2);
	...
	{
		Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
		Director::getInstance()->replaceScene(Ledger::createScene());
	}
}


//이동 클릭시 메뉴창
void StudentUnionScene::menuspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
...
void StudentUnionScene::servicespr(Ref *pSender)
{
	/*Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
	Director::getInstance()->replaceScene(MiniGameStudentUnionScene::createScene());*/
}
//일지 판업창
void StudentUnionScene::planspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
		if (openB == false)
		{
...
void StudentUnionScene::cancelcon(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	removeChildByTag(8);
	removeChildByTag(9);
...
void StudentUnionScene::finalspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("sound/button_click_16_sound_effects_.mp3", false);
	...
	if (open == false) {
		...
		auto exitok_item = MenuItemImage::create(
			...
			CC_CALLBACK_1(StudentUnionScene::exitspr, this));
...
//종료 수락시
void StudentUnionScene::exitspr(Ref *pSender)
{
...
void StudentUnionScene::SetLabel(float delta)
{
	...
	void StudentUnionScene::InitLabel()
{
		//요일
