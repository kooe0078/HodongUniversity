...
Scene* BudongScene::createScene()
{
    auto scene = Scene::create();
    auto layer = BudongScene::create();
...
bool BudongScene::init()
{
	...
	//스케쥴
	this->schedule(schedule_selector(BudongScene::update));
	this->schedule(schedule_selector(BudongScene::SetLabel), 0.001f);
	////키보드 리스너
	//auto keylistener = EventListenerKeyboard::create();
	//keylistener->onKeyPressed = CC_CALLBACK_2(BudongScene::onKeyPressed, this);
	//keylistener->onKeyReleased = CC_CALLBACK_2(BudongScene::onKeyReleased, this);
	//_eventDispatcher->addEventListenerWithSceneGraphPriority(keylistener, this);

    return true;
}

void BudongScene::InitBackGround()
{
...
void BudongScene::InitMenu()
{
	...
	auto menu_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(BudongScene::menuspr, this));
	...
	auto action_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(BudongScene::actionspr, this));
	...
	auto info_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(BudongScene::infospr, this));
	...
	auto plan_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(BudongScene::planspr, this));
	...
	auto system_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(BudongScene::systemspr, this));
	...
	auto fin_item = MenuItemImage::create(
		...
		CC_CALLBACK_1(BudongScene::finalspr, this));
...
//내정보 판업창
void BudongScene::infospr(Ref *pSender)
{
	...
	if (open == false) {
		...
		auto cancel_item = MenuItemImage::create(
			...
			CC_CALLBACK_1(BudongScene::cancelcon, this));
...
//시스템창
void BudongScene::systemspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("MiniGameResources/button_click_16_sound_effects_.mp3", false);
	if (open == false)
	{
		...
		auto on_item = MenuItemImage::create(
			...
			"MiniGameResources/on_swich.png",
			CC_CALLBACK_1(BudongScene::soundoff, this));
...
void BudongScene::soundoff(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("MiniGameResources/button_click_16_sound_effects_.mp3", false);
	...
	auto off_item = MenuItemImage::create(
		...
		"MiniGameResources/off_swich.png",
		CC_CALLBACK_1(BudongScene::soundon, this));
...
void BudongScene::soundon(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("MiniGameResources/button_click_16_sound_effects_.mp3", false);
	//노래 다시 온
	SimpleAudioEngine::getInstance()->playBackgroundMusic("sound/invest sound.mp3", true);
...
//행동 클릭시 메뉴창
void BudongScene::actionspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("MiniGameResources/button_click_16_sound_effects_.mp3", false);
	if (open == false) {
		...
		auto action_item = MenuItemImage::create(
			...
			// 임시 
			CC_CALLBACK_1(BudongScene::tell, this));
		...
		auto action_item1 = MenuItemImage::create(
			"MiniGameResources/UI_move19.png",
			"MiniGameResources/UI_move19pr.png",
			// 임시 
			CC_CALLBACK_1(BudongScene::servicespr, this));
		...
		auto action_item2 = MenuItemImage::create(
			"MiniGameResources/UI_move18.png",
			"MiniGameResources/UI_move18pr.png",
			// 임시 
			CC_CALLBACK_1(BudongScene::invest, this));
...
//투자하기
void BudongScene::invest(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("MiniGameResources/button_click_16_sound_effects_.mp3", false);

	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
	Director::getInstance()->replaceScene(InvestScene::createScene());
}
//이동 클릭시 메뉴창
void BudongScene::menuspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("MiniGameResources/button_click_16_sound_effects_.mp3", false);
...
void BudongScene::newsspr(Ref *pSender)
{
	
}
//행동-대화하기
void BudongScene::tell(Ref *pSender)
{
	Singletons::getInstance()->num_5 = 2;
	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
	Director::getInstance()->replaceScene(StoryChangeScene::createScene());

}
//신문보기
void BudongScene::servicespr(Ref *pSender)
{
	removeChildByTag(11);
	...
	click->setPosition(Point(630, 275));
	click->setTag(119);
	this->addChild(click, 2);
...
void BudongScene::news(Ref *pSender)
{
	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
	Director::getInstance()->replaceScene(NewsScene::createScene());

	
}
//일지 판업창
void BudongScene::planspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("MiniGameResources/button_click_16_sound_effects_.mp3", false);
		if (openB == false)
		{
...
void BudongScene::cancelcon(Ref *pSender)
{
	removeChildByTag(8);
	removeChildByTag(9);
	removeChildByTag(10);
	...
	removeChildByTag(109);
	removeChildByTag(110);
	removeChildByTag(111); removeChildByTag(320);
	removeChildByTag(321);
	removeChildByTag(322);
	removeChildByTag(323);
	removeChildByTag(324);
...
void BudongScene::finalspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("MiniGameResources/button_click_16_sound_effects_.mp3", false);
	...
	if (open == false) {
		...
		auto exitok_item = MenuItemImage::create(
			...
			CC_CALLBACK_1(BudongScene::exitspr, this));
...
//종료 수락시
void BudongScene::exitspr(Ref *pSender)
{
	SimpleAudioEngine::getInstance()->playEffect("MiniGameResources/button_click_16_sound_effects_.mp3", false);
...
void BudongScene::SetLabel(float delta)
{
